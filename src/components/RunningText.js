export default function RunningText() {
  ...
  return (
   <div className="relative bg-teal-700 py-1.5 overflow-visible">
      {/* Container yang bergerak - inline-flex biar gak kepotong */}
      <div className="inline-flex animate-running-text whitespace-nowrap">
        {/* Bagian 1 */}
        <span className="text-white text-sm font-semibold tracking-wide px-4 inline-block">
          {quote} ★ ★ ★
        </span>
        {/* Bagian 2 (Duplikat) */}
        <span className="text-white text-sm font-semibold tracking-wide px-4 inline-block">
